      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          >
            ...
            {/* FTP Tooltip */}
            {hoveredParam === "ftp" && (
              <div className="absolute z-[100] right-full -top-[84px] mr-3 w-80 p-4 bg-gradient-to-br from-slate-900 to-slate-800 text-white text-xs rounded-xl shadow-2xl border-2 border-emerald-500/30">
                {/* Header with icon */}
