...
# =========================
try:
    from cyclegraph_core import Api   # pyo3-statisk klasse
except Exception:
    print("FATAL: Klarte ikke å importere cyclegraph_core.Api. Bygg i core/: 'maturin develop --release'.")
    raise
...
def cmd_efficiency(args: argparse.Namespace) -> int:
    ...
    avg_eff, session_status, per_point_eff, per_point_status = Api.calculate_efficiency_series(watts, pulses)
...
def cmd_session(args: argparse.Namespace) -> int:
    ...
    for path in paths:
        ...
        out_json = Api.analyze_session_json(samples_json, meta_json, cfg_json)
